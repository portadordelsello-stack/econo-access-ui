async function initTallerVentiladores() {
    await loadTallerVentiladoresData();
}

async function loadTallerVentiladoresData() {
    try {
        const res = await api('/servicios/taller/ventiladores');
        ...
        createAccessDatasheet(res, 'taller-ventiladores-grid', columns);
    } catch (e) {
        console.error('Error loading taller-ventiladores data:', e);
    }
}
