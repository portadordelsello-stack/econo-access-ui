...
function getTabTitle(hash) {
  ...
  if (pageName === 'recaudacion-futura-total') return 'recaudación futura total';
  ...
  if (pageName === 'taller-aceptado') return 'TALLER ACEPTADO';
  if (pageName === 'taller-terminado') return 'TALLER TERMINADO';
  if (pageName === 'taller-espera') return 'taller espera';
  ...
  if (pageName === 'traer-confirmar') return 'TRAER a confirmar';
  if (pageName === 'llevado-ayer') return 'LLEVADO AYER';
  if (pageName === 'llevar-manana') return 'LLEVAR ACEPTADO MAÑANA';
  if (pageName === 'llevar-manana-mas') return 'LLEVAR ACEPTADO pas pas MAÑANA';
  if (pageName === 'traer-manana-mas') return 'traer mañana mas';
  if (pageName === 'ingresados-ayer') return 'ingresados ayer';
