async function initTallerLavarropas() {
    await loadTallerLavarropasData();
}

async function loadTallerLavarropasData() {
    try {
        const res = await api('/servicios/taller/lavarropas');
        ...
        createAccessDatasheet(res, 'taller-lavarropas-grid', columns);
    } catch (e) {
        console.error('Error loading taller-lavarropas data:', e);
    }
}
